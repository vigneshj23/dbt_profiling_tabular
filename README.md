...
{{ dbt_profiling_tabular.data_profiling('destination_database','destination_schema','destination_table', 'source_database',['source_schema1','source_schema2'],exclude_tables=[table1,table2,...],include_tables=[table1,table2,...])}}
